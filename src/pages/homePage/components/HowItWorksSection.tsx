...
import { Search, BookOpen, FileCheck, Award, Sparkles } from "lucide-react";
...
const steps = [
  {
    ...
    description: "Browse our course catalogue and select the training that meets your learning needs.",
  },
  {
    icon: BookOpen,
    step: "02",
    title: "Start Learning",
    description: "Access structured chapters, videos and supporting resources through your online account.",
  },
  {
    icon: FileCheck,
    step: "03",
    title: "Complete the Assessments",
    description: "Answer the chapter questions and successfully complete the final course assessment.",
  },
  {
    icon: Award,
    step: "04",
    title: "Receive Your Certificate",
    description: "Download your certificate after meeting the course completion requirements.",
  },
];
  ...
  return (
    <section className="py-16 relative overflow-hidden bg-slate-50/50">
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <FloatingBlob className="w-96 h-96 bg-teal-300 -top-20 -left-20" delay={0} />
      ...
      <div className="container relative z-10 mx-auto ">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-mentora tracking-tight">
            How It <span className="text-supperagent relative inline-block">
              Works
          ...
          <p className="text-gray-800 text-lg leading-relaxed">
            We've simplified the learning process so you can focus on what matters most: building knowledge and confidence to support people safely.
          </p>
        </motion.div>
